...
UniDPP Ruby library (github.com/unidpp) — see ~/src/unidpp/TODO.impl/.
License: MIT.
...
`isoiecjtc5/PLAN.md` core (invariants I1–I14, seams S1–S12) — the library
...
P1 groundwork per `TODO.impl/00-MASTER.md`: model + event log + registry
